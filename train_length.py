...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 13 16:48:52 2018
...
def label_feature(train_data_,test_data_):
...
#train_data_,test_data_=label_feature(train_data_,test_data_)
...
test_data_['label'].to_csv('./submit/new_feature/result_baseline.csv',index = False)
